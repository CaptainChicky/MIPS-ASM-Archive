...
#
# Simple operations like loading from display_mouse_held or changing display_tm_scx can be
# performed directly without wrapper functions. Complex operations like frame synchronization
# require specific instruction sequences and are therefore implemented as driver functions.
